...
- [操作系统大赛：基于 eBPF 的容器监控工具 Eunomia 初赛报告](#操作系统大赛基于-ebpf-的容器监控工具-eunomia-初赛报告)
  - [1. 目录](#1-目录)
  - [2. 目标描述](#2-目标描述)
    - [2.1. 功能概述](#21-功能概述)
...
- [目标主机上所有的容器信息。倘若想获得指定容器的信息，只需要在路径中指定容器id即可。例如，如果想得到容器内的进程信息，可以向容器所在主机ip的`/containers/container_id/top`路径发送unix.socket请求，之后解析返回数据，即可以得到容器中的进程信息，其效果和在容器所在主机上运行`docker top container_id`命令一样。](#目标主机上所有的容器信息倘若想获得指定容器的信息只需要在路径中指定容器id即可例如如果想得到容器内的进程信息可以向容器所在主机ip的containerscontainer_idtop路径发送unixsocket请求之后解析返回数据即可以得到容器中的进程信息其效果和在容器所在主机上运行docker-top-container_id命令一样)
  ...
  - [12. 附录](#12-附录)
    - [12.1. Prometheus 观测指标](#121-prometheus-观测指标)
      - [12.1.1. Process Metrics](#1211-process-metrics)
        - [12.1.1.1. Metrics List](#12111-metrics-list)
        - [12.1.1.2. Labels List](#12112-labels-list)
      - [12.1.2. files Metrics](#1212-files-metrics)
        - [12.1.2.1. Metrics List](#12121-metrics-list)
        - [12.1.2.2. Labels List](#12122-labels-list)
      - [12.1.3. Tcp Connect Metrics](#1213-tcp-connect-metrics)
        - [12.1.3.1. Metrics List](#12131-metrics-list)
        - [12.1.3.2. Labels List](#12132-labels-list)
      - [12.1.4. Syscall Metrics](#1214-syscall-metrics)
        - [12.1.4.1. Metrics List](#12141-metrics-list)
        - [12.1.4.2. Labels List](#12142-labels-list)
      - [12.1.5. Security Event Metrics](#1215-security-event-metrics)
        - [12.1.5.1. Metrics List](#12151-metrics-list)
        - [12.1.5.2. Labels List](#12152-labels-list)
      - [12.1.6. Service Metrics](#1216-service-metrics)
        - [12.1.6.1. Metrics List](#12161-metrics-list)
        - [12.1.6.2. Labels List](#12162-labels-list)
