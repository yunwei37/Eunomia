...
int main(int argc, char **argv)
{
  ...
  auto prometheus_event_handler =
      std::make_shared<oomkill_tracker::prometheus_event_handler>(oomkill_tracker::prometheus_event_handler(server));
  auto json_event_printer = std::make_shared<oomkill_tracker::plain_text_event_printer>(oomkill_tracker::plain_text_event_printer{});
  ...
  auto tracker_ptr = oomkill_tracker::create_tracker_with_default_env(prometheus_event_handler);
