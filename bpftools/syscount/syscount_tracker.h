...
#ifndef SYSCOUNT_TRACKER_H
#define SYSCOUNT_TRACKER_H
...
static const struct argp_option opts[] = {
  ...
  { "interval",
    ...
    "INTERVAL",
    0,
    "Print summary at this interval"
  ...
  { "errno",
    ...
    "ERRNO",
    0,
    "Trace only syscalls that return this error"
...
static error_t parse_arg(int key, char *arg, struct argp_state *state)
{
  ...
  switch (key)
  {
    ...
    case 'x': env.failures = true; break;
    case 'L': env.latency = true; break;
    case 'm': env.milliseconds = true; break;
    case 'P': env.process = true; break;
    case 'p':
    ...
    case 'e':
      ...
      break;
    case 'l': env.list_syscalls = true; break;
...
int start_syscount(int argc, char **argv)
{
