...
#ifndef TCPRTT_TRACKER_H
#define TCPRTT_TRACKER_H
// SPDX-License-Identifier: (LGPL-2.1 OR BSD-2-Clause)
...
static const struct argp_option opts[] = {
  ...
  { "byladdr", 'b', NULL, 0, "show sockets histogram by local address" },
  { "byraddr", 'B', NULL, 0, "show sockets histogram by remote address" },
...
static error_t parse_arg(int key, char *arg, struct argp_state *state)
{
  ...
  switch (key)
  {
    ...
    case 'd':
      ...
      break;
    case 'T': env.timestamp = true; break;
    case 'm': env.milliseconds = true; break;
    case 'p':
      errno = 0;
    ...
    case 'A':
      ...
      break;
    case 'b': env.laddr_hist = true; break;
    case 'B': env.raddr_hist = true; break;
    case 'e': env.extended = true; break;
...
static int start_tcprtt(int argc, char **argv)
{
