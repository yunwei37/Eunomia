...
static __always_inline bool filter_port(uint16_t port) {
  int i;
...
static __always_inline void count_v4(struct sock *sk, uint16_t dport) {
...
static __always_inline void count_v6(struct sock *sk, uint16_t dport) {
